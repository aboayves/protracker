...
$mod_strings = array (
  ...
  'LBL_SEARCH' => 'Suche:',
  'LBL_SESSION_TIMEOUT_TOOLTIP' => 'Der Portal Session Timeout ist für legacy Versionen von Sugar Portal verfügbar in 6.5 und älter.',
  ...
  'LBL_WIZARD_FINISH' => 'Klciken Sie weiter um Ihre persönlichen Einstellungen vorzunehmen.',
  'LBL_WIZARD_FINISH_BUTTON' => 'Ende',
  'LBL_WIZARD_FINISH_TAB' => 'Ende',
  'LBL_WIZARD_FINISH_TITLE' => 'Die Grundeinstellungen sind nun vorgenommen',
  'LBL_WIZARD_LOCALE_DESC' => 'Geben Sie an in welchem Form,at Sie Daten in Sugar angezeigt haben möchten. Diese Einstellungen sind Vorgabewerte für alle Benutzer die diese aber auch individuell anpassen können.',
  'LBL_WIZARD_NEXT_BUTTON' => 'Weiter >',
  'LBL_WIZARD_SKIP_BUTTON' => 'überspringen',
  'LBL_WIZARD_SMTP_DESC' => 'Bitte geben Sie einen E-Mail Account an unter dem SugarCRM E-Mails (z.B. für Zuweisung von Objekten, neue Passörter, etc.) versenden kann.',
  'LBL_WIZARD_SYSTEM_DESC' => 'Geben Sie den Namen Ihres Unternehmen and sowie Ihr Logo um Sugar an Ihr Unternehmen anzupassen.',
  'LBL_WIZARD_SYSTEM_TITLE' => 'Branding',
  'LBL_WIZARD_TITLE' => 'Admin Wizard',
  'LBL_WIZARD_WELCOME' => 'Klicken Sie wieter um Sugar zu lokalisieren und an Ihr Unternehmen anzupassen. Wenn Sie dies später tun wollen Klicken sie Überspringen.',
  ...
  'NEW_LOGO_HELP_NO_SPACE' => 'Das Dateiformat des Bildes kann entweder .png oder .jpg sein. Die maximale Höhe ist 17px und die maximale Breite 450px. Bilder, die diese Dimensionen überschreiten werden auf diese Größe skaliert. Der Dateiname darf keine Leerzeichen enthalten.',
