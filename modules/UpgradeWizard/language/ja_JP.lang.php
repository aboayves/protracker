...
$mod_strings = array (
  ...
  'LBL_UW_PATCH_READY' => 'パッチを実行する準備ができました。実行ボタンをクリックするとアップグレードが開始されます。',
  ...
  'LBL_UW_PREFLIGHT_FILES_DESC' => '下記のファイルが更新されています。手作業でのマージが必要なファイルはチェックをはずしてください。<i>レイアウトが変更されているファイルは自動的にチェックがはずれています。上書きしても良いファイルは再度チェックを入れてください。',
  ...
  'LBL_MODULELOADER' => 'モジュールローダー',
  'LBL_PATCHUPGRADES' => 'パッチアップグレード',
  'LBL_THEMES' => 'テーマ',
  'LBL_WORKFLOW' => 'ワークフロー',
  'LBL_UPGRADE' => 'アップグレード',
  'LBL_PROCESSING' => '実行中',
