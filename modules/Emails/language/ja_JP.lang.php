...
$mod_strings = array (
  ...
  'LBL_USERS' => 'ユーザ',
  'LNK_ALL_EMAIL_LIST' => 'すべての電子メール',
  'LNK_ARCHIVED_EMAIL_LIST' => '保存済み電子メール',
  'LNK_CALL_LIST' => '電話',
  ...
  'LBL_LIST_TIME' => '送信時間',
  'LBL_LIST_TYPE' => 'タイプ',
  'NTC_REMOVE_INVITEE' => '本当にこの受信者を電子メールからはずしてよいですか？',
  ...
  'LBL_EMAILTEMPLATE_MESSAGE_MULTIPLE_RECIPIENTS' => '取引先担当者の名前などを含む電子メールテンプレートを用いて複数の受信者にメールを送信すると予期せぬ結果を招くことがあります。一括メールを送信する際は電子メールキャンペーンを利用することをお勧めします。',
  ...
  'LBL_HELP' => 'ヘルプ',
  'LBL_WAIT' => '待機',
  'LBL_CHECKEMAIL' => '電子メール確認',
  'LBL_COMPOSEEMAIL' => '電子メール作成',
  'LBL_EMAILSETTINGS' => 'メール設定',
  'LBL_CONTACTS_SUBPANEL_TITLE_SNIP' => '電子メール宛先',
