 ...
 * PLACE ANY CUSTOMIZATIONS IN av_Offices
 */

require_once('include/SugarObjects/templates/company/Company.php');

class av_Offices_sugar extends Company {
	var $new_schema = true;
	var $module_dir = 'av_Offices';
	var $object_name = 'av_Offices';
	var $table_name = 'av_offices';
