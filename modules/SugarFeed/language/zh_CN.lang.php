...
$mod_strings = array (
  ...
  'LBL_AUTHENTICATION_PENDING' => '不是所有的您已选择的外部客户已经被认证。 点击 $#39;取消$#39; 返回选项窗口去认证外部客户，或者是点击 $#39;确认$#39; 不认证继续进行。',
  ...
  'LBL_DESCRIPTION' => '说明',
  'LBL_DONE' => '完成',
  'LBL_ENABLE_EXTERNAL_CONNECTORS' => '<i>注意: 为使用户能查看Facebook和Twitter的信息，到连接器设置页面设置Facebook和Twitter的连接器。</i>',
