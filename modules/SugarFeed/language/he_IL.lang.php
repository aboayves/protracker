...
$mod_strings = array (
  ...
  'LBL_ADMIN_SETTINGS' => 'הגדרות לפידים',
  ...
  'LBL_SUGAR_FEED_SUBPANEL_TITLE' => 'פיד',
  ...
  'LBL_TITLE'=>'כותרת',
  'LBL_ROWS'=>'שורות',
  'LBL_MY_FAVORITES_ONLY'=>'רק הנבחרים שלי',
  ...
  'CREATED_CONTACT'=>'צור <b>חדש</b> איש קשר',
  'CREATED_OPPORTUNITY'=>'צור <b>חדשה</b> הזדמנות',
  'CREATED_CASE'=>'צור <b>חדש</b> אירוע',
  'CREATED_LEAD'=>'צור <b>חדש</b> ליד',
  'FOR'=>'for',
  'CLOSED_CASE'=>'<b>סגור</b> אירוע ',
  'CONVERTED_LEAD'=>'<b>הומר</b> ליד',
  'WON_OPPORTUNITY'=>'מכיל <b>בהצלחה</b> הזדמנות',
  'WITH' => 'עם',
  ...
  'LBL_SELECT' => 'בחר',  
  'LBL_POST' => 'פרסם', 
  'LBL_EXTERNAL_PREFIX' => 'חיצוני: ',
  'LBL_EXTERNAL_WARNING' => 'פריטים המסומנים כ"חיצוניים" נדרש עבורם <a href="?module=EAPM">חשבון חיצוני</a>.',
