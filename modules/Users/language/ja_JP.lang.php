...
$mod_strings = array (
  ...
  'LBL_DELETE_USER_CONFIRM' => 'ユーザレコードを削除すると当該従業員レコードも削除されます。ユーザを削除すると、当該ユーザを含むワークフロー定義やレポートを更新する必要があります。<br/><br/>ユーザの削除は元に戻せません。',
  ...
  'ERR_IE_FAILURE2' => '電子メールアカウントでの接続に問題がありました。設定を確認して再度実施してください。',
  ...
  'LBL_NUMBER_GROUPING_SEP_TEXT' => '1000位の区切り文字',
  'LBL_DECIMAL_SEP' => '小数点シンボル',
  'LBL_DECIMAL_SEP_TEXT' => '小数点を区切り文字',
  'LBL_FDOW' => '週の最初の日',
  'LBL_FDOW_TEXT' => '週、月、年の表示で表示する最初の日',
  ...
  'LBL_MAIL_OPTIONS_TITLE' => '電子メール設定',
