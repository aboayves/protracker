 ...
 * PLACE ANY CUSTOMIZATIONS IN av_Companies
 */

require_once('include/SugarObjects/templates/company/Company.php');

class av_Companies_sugar extends Company {
	var $new_schema = true;
	var $module_dir = 'av_Companies';
	var $object_name = 'av_Companies';
	var $table_name = 'av_companies';
	var $importable = true;
		var $id;
		var $name;
		var $date_entered;
