...
$mod_strings = array (
  ...
  'LNK_EMAIL_TEMPLATE_LIST' => '電子メールテンプレート一覧',
  ...
  'LBL_COPY_AND_PASTE_CODE' => 'もしくは下記のHTMLをコピーして既存ページに貼り付けてください。',
  ...
  'ERR_NO_EMAIL_MARKETING' => 'キャンペーンに関連付けた有効な電子メールマーケティングメッセージが少なくとも１つ必要です。',
  ...
  'ERR_MESS_NOT_FOUND_FOR_LIST' => 'このターゲットリストの電子メールマーケティングメッセージが見つかりません。',
  ...
  'LBL_UNSUBSCRIBED_HEADER_EXPL' => '購読解除するニュースレターに移動することで、取引先担当者をこのニュースレターの解約リストに追加します。これにより、元の購読リストもしくはターゲットリストから取引先担当者を削除することはありません。',
  ...
  'LBL_WIZARD_MARKETING_MESSAGE' => 'ニュースレターを配信するための電子メールインスタンスを作成するには以下を入力してください。このフォームでいつどのようにニュースレターを配信するかを設定できます。',
  ...
  'LBL_WIZ_MARKETING_TITLE' => 'マーケティング電子メール',
  ...
  'LBL_CAMP_MESSAGE_COPY_DESC' => 'すべてのキャンペーンで送った<bold>すべての</bold>電子メールメッセージについて完全なコピーを保存しますか？<bold>いいえを推奨します。</bold> いいえを選ぶと使用したテンプレートのみが保存され、個々のメッセージは変数によって再生成されます。',
  'LBL_YES' => 'はい',
  'LBL_NO' => 'いいえ',
  ...
  'LBL_MAILBOX_CHECK2_BAD' => 'システムメールアドレスを設定してください。電子メール設定が実施されていないか、設定が正しくありません。',
  ...
  'LBL_MARKETING_CHECK1_GOOD' => '電子メールマーケティング用の設定が見つかりました。',
  'LBL_MARKETING_CHECK1_BAD' => '電子メールマーケティング用の設定が１つも見つかりませんでした。少なくとも１つは必要です。',
  ...
  'LBL_INVALID EMAIL_SUBPANEL_TITLE' => '無効な電子メール',
