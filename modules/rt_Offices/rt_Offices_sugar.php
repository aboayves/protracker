 ...
 * PLACE ANY CUSTOMIZATIONS IN rt_Offices
 */

require_once('include/SugarObjects/templates/company/Company.php');

class rt_Offices_sugar extends Company {
	var $new_schema = true;
	var $module_dir = 'rt_Offices';
	var $object_name = 'rt_Offices';
	var $table_name = 'rt_offices';
