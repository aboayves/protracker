...
$mod_strings = array (
  ...
  'LBL_LIST_CITY' => '市区町村',
  'LBL_LIST_EMAIL_ADDRESS' => '電子メールアドレス',
  'LBL_LIST_PHONE' => '電話',
  'LBL_LIST_STATE' => '都道府県',
  ...
  'LBL_OTHER_EMAIL_ADDRESS' => 'その他の電子メール:',
  ...
  'MSG_SHOW_DUPLICATES' => 'あなたが作成しようとしている取引先は既存の取引先と重複する可能性があります。類似の取引先は下記に表示されています。保存をクリックして新たに取引先を作成するか、キャンセルをクリックして取引先を作成せずにモジュールに戻ります。',
