...
$mod_strings = array (
  ...
  'MSG_SHOW_DUPLICATES' => 'あなたが作成しようとしているターゲットは既に存在するターゲットと重複する可能性があります。類似の名前やメールアドレスを持つターゲットは下記に表示されています。<br>保存をクリックして新たにターゲットを作成するか、選択をクリックして以下のリストからターゲットを選択してください。',
  'MSG_DUPLICATE' => 'あなたが作成しようとしているターゲットは既に存在するターゲットと重複する可能性があります。類似のターゲットは下記に表示されています。<br>保存をクリックして新たにターゲットを作成するか、キャンセルをクリックするとターゲットを作成せずにモジュールに戻ります。',
