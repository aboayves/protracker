...
$mod_strings = array (
	...
	'ACCOUNT_REMOVE_PROJECT_CONFIRM' => 'Are you sure you want to remove this client from the project?',
	'ERR_DELETE_RECORD' => 'You must specify a record number in order to delete the client.',
	...
	'MSG_DUPLICATE' => 'The client record you are about to create might be a duplicate of an client record that already exists. Client records containing similar names are listed below.<br>Click Create Client to continue creating this new client, or select an existing client listed below.',
	'MSG_SHOW_DUPLICATES' => 'The client record you are about to create might be a duplicate of an client record that already exists. Client records containing similar names are listed below.<br>Click Save to continue creating this new client, or click Cancel to return to the module without creating the client.',
