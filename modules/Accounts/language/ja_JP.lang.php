...
$mod_strings = array (
  ...
  'MSG_DUPLICATE' => 'あなたが作成しようとしている取引先は既存の取引先と重複する可能性があります。類似の取引先は下記に表示されています。<br>取引先作成をクリックして新たに取引先を作成するか、以下のリストから既存の取引先を選択してください。',
  'MSG_SHOW_DUPLICATES' => 'あなたが作成しようとしている取引先は既存の取引先と重複する可能性があります。類似の取引先は下記に表示されています。<br>保存をクリックして新たに取引先を作成するか、キャンセルをクリックして取引先を作成せずにモジュールに戻ります。',
