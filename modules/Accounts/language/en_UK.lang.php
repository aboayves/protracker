...
$mod_strings = array (
	...
	'MSG_DUPLICATE' => 'The alient record you are about to create might be a duplicate of a client record that already exists. Client records containing similar names are listed below.<br>Click Save to continue creating this new client, or click Cancel to return to the module without creating the client.',
	'MSG_SHOW_DUPLICATES' => 'The client record you are about to create might be a duplicate of a client record that already exists. Client records containing similar names are listed below.<br>Click Save to continue creating this new client, or click Cancel to return to the module without creating the client.',
