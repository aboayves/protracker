...
$mod_strings = array (
  ...
  'ERR_INVALID_TEAM_REASSIGNMENT' => 'Hata. Seçilen takım ({0}) . Lütfen başka bir takım seçin.',
  ...
  'LBL_NAME' => 'Takım Adı:',
  'LBL_NAME_2' => 'Takım Adı(2):',
  'LBL_PRIMARY_TEAM_NAME' => 'Temel Takım İsmi',
  ...
  'LBL_REASSIGN_TEAM_TITLE' => 'Şu takım(lar) için atanmış kayıtlar bulunmaktadır: {0}<br />Takım(ları)ı silmeden önce bu kayıtları yeni takıma tekrar atamalısınız. Yenileme için kullanılacak takım seçin.',
  'LBL_REASSIGN_TEAM_BUTTON_KEY' => 'T',
  'LBL_REASSIGN_TEAM_BUTTON_LABEL' => 'Tekrar Belirle',
  'LBL_REASSIGN_TEAM_BUTTON_TITLE' => 'Tekrar Belirle [Alt+R]',
