...
$mod_strings = array (
  ...
  'LBL_MODULE_TITLE' => 'Munkafolyamat eseménykezelő : Főoldal',
  'LBL_MODULE_SECTION_TITLE' => 'Mikor ezek a feltételek teljesülnek',
  'LBL_SEARCH_FORM_TITLE' => 'Munkafolyamat indítás kereső',
  'LBL_LIST_FORM_TITLE' => 'Indítás lista',
  'LBL_NEW_FORM_TITLE' => 'Új indítás létrehozása',
  'LBL_LIST_NAME' => 'Leírás:',
  'LBL_LIST_VALUE' => 'Érték:',
  'LBL_LIST_TYPE' => 'Típus:',
  'LBL_LIST_EVAL' => 'Értékel:',
  'LBL_LIST_FIELD' => 'Mező:',
  'LBL_NAME' => 'Eseménykezelő neve:',
  'LBL_TYPE' => 'Típus:',
  'LBL_EVAL' => 'Indítás értékelés:',
  'LBL_SHOW_PAST' => 'Előző érték módosítása:',
  'LBL_SHOW' => 'Mutat',
  'LNK_NEW_TRIGGER' => 'Új eseménykezelő létrehozása',
  'LNK_TRIGGER' => 'Munkafolyamat indítások ',
  'LBL_LIST_STATEMEMT' => 'Indítás a következő esemény alapján:',
  'LBL_FILTER_LIST_STATEMEMT' => 'Szűrés a követkő feladatok alapján:',
  'NTC_REMOVE_TRIGGER' => 'Biztos el akarja távolítani ezt az indítást?',
  'LNK_NEW_WORKFLOW' => 'Munkafolyamat létrehozása',
  'LNK_WORKFLOW' => 'Munkafolyamat témái',
  'LBL_ALERT_TEMPLATES' => 'Riasztási sablonok',
  'LBL_TRIGGER' => 'Mikor',
  'LBL_FIELD' => 'Mező',
  'LBL_VALUE' => 'Érték:',
  'LBL_RECORD' => 'Modul',
  'LBL_COMPARE_SPECIFIC_TITLE' => 'Amikor egy mező a célmodulban megváltozik vagy egy meghatározott értékről ',
  'LBL_COMPARE_SPECIFIC_PART' => 'átváltozik vagy meghatározott értékről',
  'LBL_COMPARE_SPECIFIC_PART_TIME' => '_',
  ...
  'LBL_FILTER_FIELD_TITLE' => 'Amikor a célmodul tartalmaz egy meghatározott mezőt',
  ...
  'LBL_FUTURE_TRIGGER' => 'Adja meg az új értéket',
  'LBL_PAST_TRIGGER' => 'Adja meg a régi értéket',
  ...
  'LBL_NEW_FILTER_BUTTON_TITLE' => 'Új szűrő létrehozása [Alt+F]',
  'LBL_NEW_FILTER_BUTTON_LABEL' => 'Új  szűrő létrehozása',
  'LBL_NEW_TRIGGER_BUTTON_TITLE' => 'Új indítás létrehozása  [Alt+T]',
  'LBL_NEW_TRIGGER_BUTTON_LABEL' => 'Új indítás létrehozása',
  'LBL_LIST_FRAME_SEC' => 'Szűrő:',
  'LBL_LIST_FRAME_PRI' => 'Indítás:',
  'LBL_TRIGGER_FILTER_TITLE' => 'Indítás szűrők',
  ...
  'LBL_APOSTROPHE_S' => 'valakinek a ...',
  'LBL_WHEN_VALUE1' => 'Ha a mező értéke ',
  'LBL_WHEN_VALUE2' => 'Ha az értéke ',
  'LBL_SELECT_OPTION' => 'Kérjük, válasszon ki egy lehetőséget!',
  'LBL_SELECT_TARGET_FIELD' => 'Kérem, válasszon egy célterületet!',
  'LBL_SELECT_TARGET_MOD' => 'Kérem, válasszon egy kapcsolódó modult!',
  ...
  'LBL_SELECT_2ND_FILTER' => 'Válasszon ki egy érvényes 2. szűrőmezőt',
);
