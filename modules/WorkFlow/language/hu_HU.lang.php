...
$mod_strings = array (
  ...
  'LBL_CREATE_ALERT_TEMPLATE' => 'Hozzon létre egy figyelmeztető sablont:',
  'LBL_SUBJECT' => 'Tárgy:',
  'LBL_RECORD_TYPE' => 'Alkalmazható:',
  'LBL_RELATED_MODULE' => 'Kapcsolódó modulok:',
  'LBL_PROCESS_LIST' => 'Munkafolyamat végrehajtási sorrendje',
  'LNK_ALERT_TEMPLATES' => 'Figyelmeztető Email-sablon',
  'LNK_PROCESS_VIEW' => 'Munkafolyamat végrehajtási sorrendje',
  'LBL_PROCESS_SELECT' => 'Kérjük, válasszon egy modult:',
  'LBL_LACK_OF_TRIGGER_ALERT' => 'Megjegyzés: A funkcióban létre kell hoznia egy indítást ehhez a munkafolyamathoz',
  'LBL_LACK_OF_NOTIFICATIONS_ON' => 'Megjegyzés: Ahhoz, hogy az SMTP szerver információkat küldjön > Email beállítások ',
  'LBL_FIRE_ORDER' => 'Végrehajtási sorrend:',
  'LBL_RECIPIENTS' => 'Címzettek',
  'LBL_INVITEES' => 'Meghívottak',
  'LBL_INVITEE_NOTICE' => 'Figyelem, a létrehozáshoz ki választania legalább egy meghívottat.',
  'NTC_REMOVE_ALERT' => 'Biztosan el akarja távolítani ezt a munkafolyamatot?',
  'LBL_EDIT_ALT_TEXT' => 'Szöveg buborék',
  'LBL_INSERT' => 'Beszúrás',
  'LBL_SELECT_OPTION' => 'Kérjük, válasszon ki egy lehetőséget!',
  'LBL_SELECT_VALUE' => 'Ki kell választania egy értéket!',
  'LBL_SELECT_MODULE' => 'Kérjük, válasszon egy kapcsolódó modult!',
  ...
  'LBL_INVITE_LINK' => 'Találkozó / Call meghívó Link',
  'LBL_PLEASE_SELECT' => 'Kérem válasszon',
  'LBL_BODY' => 'Szövegtörzs:',
  'LBL__S' => 'valakinek a ...',
  'LBL_ALERT_SUBJECT' => 'Munkafolyamat riasztás',
  'LBL_ACTION_ERROR' => 'Ez a művelet nem hajtható végre. Javítsa úgy, hogy a mezők és értékeik érvényesek legyenek',
  'LBL_ACTION_ERRORS' => 'Figyelem: Egy vagy több folyamat hibákat tartalmaz.',
  ...
  'LBL_TRIGGER_ERROR' => 'Figyelem: Ez az indítás érvénytelen értékeket tartalmaz, nem fog lefutni.',
  'LBL_TRIGGER_ERRORS' => 'Figyelem: egy vagy több indítás az alábbi hibákat tartalmazza:',
);
