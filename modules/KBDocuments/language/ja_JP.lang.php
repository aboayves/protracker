...
$mod_strings = array (
  ...
  'LBL_TOP_TEN_LIST_TITLE' => 'もっとも閲覧されている記事トップ10',
  ...
  'LBL_SYNTAX_CHEAT_SHEET' => '<B>クエリ文法のヘルプ:</b><P><br /><ol><br /><li>「+」は、結果がこの項目を「持たなければいけない」ことを示します。</li><br /><li>「-」は、結果がこの項目を「持ってはいけない」ことを示します。マイナス(-)サインは除外される単語のテキストフィールドに入力するばあいはいりません。</li><br /><li>ダブルクォーテーションマーク(")に囲まれた複数の単語("example1 example2")は１つの検索項目として扱われます。開始と終了のクォーテーションマークが無ければいけません。そうでないと検索は実行されません。<br>クォーテーションマーク自身を検索する場合は、バックスラッシュ-クォート(\\")を代わりに使ってください。</li><br /><li>シングルクォーテーションマーク(&amp;#39;)はそれ自身として検索され、グルーピングとしては機能しません。</li></ol><br /><br />        </p><br /><br /><p><b>例: </b><br><br><br />「Sugar」たは「CRM」を含み、「Knowledge Base」と「cool」を必ず含む一方で「demo」や「past tense」を含まない記事を検索する場合は次のように入力します:<br>Sugar CRM +"Knowledge Base" +cool -demo -"Past Tense"</p><br><br /><br /><p><b>注: </b><br><br /><ol><li>大文字小文字は区別されません。</li><br /><li>スペースとカンマは区切り文字として利用できます。</li><br /><li>プラス(+)もしくはマイナス(-)サインとその対象の単語の間にはスペースを入れてはいけません。</li></ol><br /></p>',
  ...
  'LBL_LAST_REV_CREATE_DATE' => '最終版の作成日',
  'LBL_KEYWORDS' => 'キーワード:',
  'LBL_CASES' => 'ケース',
  'LBL_EMAILS' => '電子メール',
