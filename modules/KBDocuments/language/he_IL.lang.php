...
$mod_strings = array (
	...
	'LBL_KBDOC_TAGS' => 'תגיות למאמרים:',
	'LBL_KBDOC_BODY' => 'גוף המאמר:',
	'LBL_KBDOC_APPROVED_BY' =>'מאשר:',
	'LBL_KBDOC_ATTACHMENT' =>'Kbdoc_צרופה',
	'LBL_KBDOC_ATTS_TITLE' =>'הורד קובץ מצורף:',	
    ...
    'LBL_SELECT_A_NODE_FROM_TREE' => 'בחר ענץ בעץ',
    ...
    'LBL_KBDOC_TAGS' => 'תגיות למסמך:',
	'LBL_KBDOC_BODY' => 'גוף המסמך:',
	'LBL_KBDOC_APPROVED_BY' =>'אושר על ידי:',
	'LBL_KBDOC_ATTACHMENT' =>'Kbdoc_צרופה',
	'LBL_KBDOC_ATTS_TITLE' =>'הורד מסמכים מצורפים:',
    ...
    'LBL_SYNTAX_CHEAT_SHEET' => 
        '<B>עזרה בחיבור שאילתות:</b><P>
        <ol>
<li>הסימן פלוס (+) מצביע על כך שהתוצאה חייבת לכלול מונח זה.</li>
<li>הסימן מינוס (-) מצביע על כך שהתוצאה לא תכיל את המונח.  הסימן מינוס (-) איננו נדרש אם החיפוש איננו מעוניין להכיל את ההמחרוזת המבוקשת.</li>
<li>מספר מילים בתוך גרשיים ("דוגמא דוגמא2") יטופלו למחרוזת בודדת. כדי שהחיפוש יופעל הוא חייב להכיל גרשיים פותחות וגרשיים סוגרות.<br>כדי לחפש מחרוזת שמכילה סוגריים השתמש ב  (\") במקום גרשיים.</li>
<li>גרש (\') יבצע חיפוש כפי שהוא ולא יחפש מחרוזת.</li></ol>

        </p>

        <p><b>דוגמא: </b><br><br>
        לחפש בכל המסמכים המכילים את המילה "שוגר" או  "מערכת שמכילים את המילה "בסיס הידע" וגם  "נחמד," אך אינם מכילים את המילה "דמו" או "בעבר," זן את המחרוזת הבאה:<br>&nbsp;&nbsp;&nbsp;&nbsp;שוגר מערכת +"בסיס הידע" +נחמד -דוגמא -"בעבר"</p><br>

        <p><b>Notes: </b><br>
<ol><li>אדיש לאותיות גדולות.</li>
<li>רווחים או פסיקים מקובלים כמסימי משפט.</li>
<li>אל תכניס רווח בין הסימנים פלוס (+) או מינוס (-) והמילים הצמודות להן.</li></ol>
</p>',
   ...
   //Admin screen messages
    ...
    'LBL_SELECT_TAGS_TO_DELETE'  => 'בחר תגיות למחיקה',
