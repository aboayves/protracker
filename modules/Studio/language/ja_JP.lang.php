...
$mod_strings = array (
  ...
  'LBL_SMA_EDIT_CUSTOMFIELDS' => 'カスタムフィールドの編集',
  ...
  'LBL_GROUP_TAB_WELCOME' => '以下のフィルタはユーザがメニュー表示にグループタブの利用を選択した場合に表示されます。それぞれのフィルタへモジュールをドラッグ＆ドロップしてください。注: 空のフィルタはメニューに表示されません。',
  ...
  'LBL_ADDITIONAL' => '追加',
  'LBL_AVAILABLE' => '有効',
  'LBL_LISTVIEW_DESCRIPTION' => '下記に３つのカラムが表示されています。デフォルトカラムには、デフォルトでリストビューに表示されるカラムが含まれています。追加カラムには、カスタムビューを作成するときに選択可能なカラムが表示されています。有効カラムには、管理者がデフォルトカラムか追加カラムに含めることが可能なカラムが表示されています。',
