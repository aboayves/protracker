...
$mod_strings = array (
  ...
  'LBL_DIFF_COL_VALUES' => 'Колонки, значения которых отличаются в объединяемых записях:',
  ...
  'LBL_STEP1_DIRECTIONS' => 'Поиск дублирующихся записей. Вы сможете указать записи, которые объединятся с текущей записью.',
);
