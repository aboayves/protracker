...
$mod_strings = array (
  'LBL_EDIT_TASK_IN_GRID_TITLE' => 'Upravit úkol v mřížce',
  'LBL_ID' => 'ID:',
  'LBL_PROJECT_TASK_ID' => 'ID projektového úkolu:',
  'LBL_PROJECT_ID' => 'ID projektu:',
  'LBL_RESOURCE' => 'Zdroje:',
  'LBL_PREDECESSORS' => 'Předchůdci:',
  'LBL_DATE_FINISH' => 'Datum ukončení:',
  'LBL_TIME_FINISH' => 'Čas ukončení:',
  'LBL_DURATION_UNIT' => 'Jednotky doby trvání:',
  'LBL_ACTUAL_DURATION' => 'Skutečné doby trvání:',
  'LBL_PARENT_TASK_ID' => 'ID mateřského úkolu:',
  'LBL_TASK_ID' => 'ID úkolu:',
  'LBL_LIST_DAYS' => 'dny',
  'LBL_LIST_ACTUAL_DURATION' => 'Aktuální doba trvání',
  ...
  'LBL_LIST_DATE_START' => 'Počáteční datum',
  ...
  'LBL_LIST_MY_PROJECT_TASKS' => 'Mé otevřené úkoly projektu',
  ...
  'DATE_JS_ERROR' => 'Prosím zadejte datum korespondujíci se zadaným časem',
  'LBL_ASSIGNED_USER_NAME' => 'Přidělen',
