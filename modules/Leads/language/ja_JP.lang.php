...
$mod_strings = array (
  ...
  'LBL_CONVERTLEAD_WARNING' => '警告: コンバートしようとしているリードのステータスはコンバート済みです。取引先担当者や取引先のレコードが既に作成されている可能性があります。コンバートを継続する場合は保存ボタンをクリックしてください。',
  ...
  'LBL_SELECT_CHECKED_BUTTON_TITLE' => 'チェック済みリードの択',
  'LBL_STATE' => '都道府県:',
  ...
  'LBL_ACTIVITIES_MOVE_HELP' => 'リードの活動に移動するレコードを選択してください。タスク、電話、会議、メモ、電子メールを選択したレコードに移動します。',
  'LBL_ACTIVITIES_COPY_HELP' => 'リードの活動にコピーするレコードを選択してください。タスク、電話、会議、メモが選択したレコードに新規で作成されます。電子メールは選択したレコードに関連付けられます。',
  'LBL_PHONE_HOME' => '自宅電話',
