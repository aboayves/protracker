...
$mod_strings = array (
  ...
  array (
    ...
    array (
      ...
      'savebtn' => 'Tüm değişiklikleri kaydetmek ve aktif hale getirmek için <b>Kaydet</b> düğmesine tıklayın.',
    ),
    'main' => 
    array (
    ...
    array (
      ...
      'existingModule' => 'Bu modülü oluşturduktan ve özelleştirdikten sonra, ek modüller oluşturabilir veya pakete dönerek paketi <b>Yayınlayabilir</b> ya da <b>Uygulayabilirsiniz</b>.<br><br><b>Aynı Kayıttan Oluştur</b> tuşuna tıkladığınızda, mevcut modül ile aynı özelliklerde yeni bir modül oluşturabilirsiniz, veya <b>Yeni Modül</b> tuşuna tıklayarak yeni bir modül oluşturabilirsiniz.<br><br>Paketi <b>Yayınlamak</b> veya <b>Uygulamak</b> için pakete dönerek bu fonksiyonları uygulayabilirsiniz. En az bir modül içeren paketleri yayınlanabilir veya uygulayabilirsiniz.',
    ...
    array (
      ...
      'newPackage' => 'Yeni bir paket oluşturmak için <b>Yeni Paket</b> tuşuna tıklayın.',
  ...
  array (
    ...
    array (
      ...
      'saveBtn' => 'Tüm değişiklikleri kaydetmek için <b>Kaydet</b> tuşuna tıklayın.',
    ),
    'layoutEditor' => 
    array (
    ...
    array (
      ...
      'savebtn' => 'Yaptığınız değişiklikleri kaydetmek ve modül içinde etkin hale getirmek için <b>Kaydet & Uygula</b> düğmesine tıklayın.',
    ),
    'module' => 
    array (
      ...
      'savebtn' => 'Modül ile ilgili tüm girilen verileri kaydetmek için <b>Kaydet</ b> tuşuna tıklayın.',
    ...
    array (
      ...
      'create' => 'Paket için <b>İsim</b> belirtin. Girdiğiniz isim  alfa numerik olmalıdır ve boşluk içermemelidir. (Örnek: HR_Management)<br/><br/>Paket için <b>Yazar</b> ve <b>Açıklama</b> bilgilerini kullanabilirsiniz.<br/><br/>Paketi oluşturmak için  <b>Kaydet</b> tuşuna tıklayın.',
      'deletebtn' => 'Bu paketi ve bu paket ile ilgili tüm dosyaları silmek için  <b>Sil</b> tuşuna tıklayın.',
      ...
      'exportbtn' => 'Paketin içindeki yapılan özelleştirmeleri içeren bir zip dosyası oluşturmak için <b>Dışarı Aktar</b> tuşuna tıklayın.<br><br> Oluşturulan dosya paketin, paketin yüklenebilir bir versiyonu değildir. <br><br><b>Modül Yükleyici</b>&#39;yi kullanarak .zip dosyasını yüklediğinizde, paket ve özelleştirmeleri Modül Oluşturucuda görebilirsiniz.',
      ...
      'new_module' => 'Bu paket için yeni bir modül oluşturmak için <b>Yeni Modül</b> tuşuna tıklayın.',
      ...
      'savebtn' => 'Paketi ile ilgili tüm girilen verileri kaydetmek için  <b>Kaydet</ b> tuşuna tıklayın.',
    ),
    'popupListViewEditor' => 
    array (
      'Default' => '<b>Varsayılan</b> alanlar kullanıcılar tarafından özelleştirilmemiş olan ListeGörünüm&#39;lerinde görünür.',
    ...
    'portalSync' => 
    array (
      'default' => 'Güncelleştirme için <b>Sugar Portal URL</b> adresini girin ve <b>Devam</b> tuşuna tıklayın.<br><br>Ardından geçerli bir Sugar kullanıcı ismi ve şifresi girip <b>Senkronizasyonu Başlat</b> tuşuna basın.<br><br>Sugar Portal <b>Düzenindeki</b> değişiklikler ve eğer yüklendi ise, <b>Stil Dosyası</b> belirtilen portal üzerine kopyalanacak.',
    ),
    'relationshipsHelp' => 
    array (
