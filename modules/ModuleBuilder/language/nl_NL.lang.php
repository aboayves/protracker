...
$mod_strings = array (
  ...
  'LBL_BUG_TRACKER' => 'Defecten Tracker',
  'LBL_CALCULATED' => 'Berekend',
  'LBL_CASES' => 'Cases',
  'LBL_CLEAR_EXTENSIONS' => 'Verwijder Extensies',
  'LBL_CLEAR_RELATIONSHIPS' => 'Verwijder Relaties',
  'LBL_COMPANY' => 'Bedrijf',
  'LBL_CONFIG_PORTAL_URL' => 'URL (link) naar een afbeelding van een aangepast logo. De aanbevolen afmetingen zijn 163 x 18 pixels.',
  ...
  'LBL_HIDEOPTIONS' => 'Verbergen opties',
  'LBL_HIGH' => 'Hoog',
  ...
  'LBL_MODULE_NAME_SINGULAR' => 'Module Naam (enkelvoud):',
  ...
  'LBL_PORTAL_APP_NAME' => 'Applicatie naam',
  'LBL_PORTAL_CONFIGURE' => 'Configureer Portal',
  'LBL_PORTAL_DEFAULT_ASSIGN_USER' => 'Vooraf ingesteld bij een nieuwe portal registratie',
  'LBL_PORTAL_DETAIL_NUMBER' => 'Aantal velden weer te geven in het detail weergave',
  'LBL_PORTAL_DISABLED_MODULES' => 'De volgende module(s) is/zijn uitgeschakeld.',
  'LBL_PORTAL_ENABLE' => 'Inschakelen',
  'LBL_PORTAL_ENABLE_MODULES' => 'Als u ze in de Sugar Portal actief wilt hebben, schakel ze dan <a id="configure_tabs" target="_blank" href="./index.php?module=Administration&amp;action=ConfigureTabs">hier in.</a>.',
  'LBL_PORTAL_GO' => 'Start',
  'LBL_PORTAL_LAYOUTS' => 'Portaal lay-outs',
  'LBL_PORTAL_LIST_NUMBER' => 'Aantal records weer te geven in de lijst',
  'LBL_PORTAL_LOGO_URL' => 'Logo URL',
  'LBL_PORTAL_ROLE_DESC' => 'Verwijder deze rol niet! De "Customer Self-Service"-rol is een door het systeem gegenereerde rol tijdens het activatieproces van de Sugar Portal. Gebruik de &#39;Access controls&#39; (het authorisatiebeheer) behorende bij deze rol om &#39;Bugs&#39;, &#39;Cases&#39; en/of &#39;Knowledge Base&#39; modules in de Sugar Portal in/uit te schakelen. Pas de authorisatie voor deze rol niet aan om onbekend en onverwacht systeemgedrag te voorkomen. Indien deze rol (per ongeluk) verwijderd is, maak deze dan opnieuw aan door de Sugar Portal eerst uit en vervolgens weer in te schakelen.',
  'LBL_PORTAL_SEARCH_RESULT_NUMBER' => 'Aantal resultaten weer te geven bij Algemene Zoekfunctie',
  'LBL_PORTAL_SITE_URL' => 'Uw Portal website is beschikbaar via:',
  ...
  'LBL_TABDEF_COLLAPSE_HELP' => 'Collapse this section by default when it&#39;s defined as a panel',
  'LBL_TABDEF_TYPE' => 'Type weergave:',
  'LBL_TABDEF_TYPE_HELP' => 'Selecteer hoe deze sectie weergegeven moet worden. Deze optie heeft alleen effect als u tabbladen in deze weergave heeft geselecteerd.',
  ...
  array (
    ...
    array (
      ...
      'audit' => 'Het aanvinken van deze checkbox zal Auditing activeren voor deze module. Wijzigingen aan bepaalde velden zullen worden opgeslagen zodat administators deze mutatiehistorie kunnen opvragen.',
      ...
      'studio' => 'Het aanvinken van deze checkbox geeft administators de mogelijkheid deze module aan te passen via de Studio',
    ...
    array (
      ...
      'subpanelBtn' => 'Bepaal welke velden worden weergegeven in het <b> Subpanels </ b> in de module.',
