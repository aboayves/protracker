...
$mod_strings = array (
  ...
  'LBL_POPHELP_VALIDATE_US_PHONE' => 'Selecionar para validar este campo como uma entrada de um número de telefone de 10 dígitos, com desconto para o código de país 1 e aplicar o formato dos E.U.A. ao número de telefone quando o registro for gravado. O seguinte formato irá ser aplicado: (xxx) xxx-xxxx.',
  'LBL_POPUP' => 'Popup',
  ...
  'LBL_PORTAL_ROLE_DESC' => 'Não exclua esse perfil. Perfill Portal Self-Service é um perfil gerado pelo sistema criado durante o processo de ativação de Sugar Portal. Use os controles de acesso dentro desta função para ativar e / ou desativar Bugs, estojos ou módulos base de conhecimento em Portal do Sugar. Não modificar quaisquer outros controles de acesso para este perfil para evitar o comportamento do sistema desconhecido e imprevisível. No caso de exclusão acidental deste perfill, recriá-lo ao desabilitar e habilitar Portal do Sugar.',
  ...
  'LBL_TABDEF_COLLAPSE_HELP' => 'Colappse esta seção como padrão quando isto for definido como painel',
  ...
  'LBL_TABDEF_TYPE_OPTION_HELP' => 'Selecione Painel para ter essa visualização do painel dentro da visão do layout. Selecione a aba para ter este painel exibido dentro de uma aba separada dentro do layout. Quando a Aba é especificado para um painel, painéis subseqüentes estabelecidos para exibir como o painel será exibido na guia.<br />Uma nova aba será iniciada para o painel seguinte para o qual a Aba está selecionada. Se a Aba é seleccionada para um painel abaixo do primeiro painel, o primeiro painel será necessariamente uma aba.',
  ...
  array (
    ...
    array (
      ...
      'historyDefault' => 'Clicar <b>Restaurar Por Defeito</b> para restaurar o layout original.',
      'modify' => 'Todos os campos que possam ser mostrados na <b>Listagem</b> aparecem aqui.<br/><br/> A coluna  <b>Por Defeito</b> contém os campos que serão mostrados na Listagem por defeito.<br/><br/> A coluna  <b>Disponíveis</b> contém campos que o utilizador pode Selecionar na pesquisa para criar uma Listagem personalizada.<br/><br/>A coluna <b>Escondidos</b> contém campos que poderão ser adicionados à coluna Por Defeito ou Disponíveis.&#39;<br />    . &#39;<br/><br/><img src="themes/default/images/SugarLogic/icon_dependent.png"/>Indica um campo Dependente que pode ou não ser visível com base em um valor de uma fórmula.<br/><img src="themes/default/images/SugarLogic/icon_calculated.png"/>Indica um campo Calculado cujo valor será determinado automaticamente com base em uma fórmula.',
