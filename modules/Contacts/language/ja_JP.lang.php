...
$mod_strings = array (
  ...
  'MSG_DUPLICATE' => 'あなたが作成しようとしている取引先担当者は既存の取引先担当者と重複する可能性があります。類似の取引先担当者は下記に表示されています。取引先担当者作成をクリックして新たに取引先担当者を作成するか、以下のリストから既存の取引先担当者を選択してください。',
  'MSG_SHOW_DUPLICATES' => 'あなたが作成しようとしている取引先担当者は既存の取引先担当者と重複する可能性があります。類似の取引先担当者は下記に表示されています。保存をクリックして新たに取引先担当者を作成するか、キャンセルをクリックして取引先担当者を作成せずにモジュールに戻ります。',
