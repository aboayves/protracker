...
$mod_strings = array (
  ...
  'MSG_DUPLICATE' => 'Şu anda oluşturmakta olduğunuz Fırsat kaydı, başka bir Fırsat kaydının aynısı olabilir. Aynı ismi içeren Fırsat kayıtları aşağıda listelenmektedir.<br>Kaydet tuşuna basarak Fırsatı oluşturmaya devam edebilir, veya İptal tuşuna basarak Fırsatı oluşturmadan modüle geri dönebilirsiniz.',
