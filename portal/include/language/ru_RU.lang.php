...
$app_strings = array (
  ...
  'ERR_NEED_ACTIVE_SESSION' => 'Активной сессии требуется экспортировать содержимое.',
  ...
  'ERR_NOTHING_SELECTED' => 'Пожалуйста, сделайте выделение перед тем, как продолжить.',
  ...
  'ERR_PORTAL_LOGIN_FAILED' => 'Невозможно создать логин-сессию на портал. Свяжитесь, пожалуйста, с администратором.',
  'ERR_RESOURCE_MANAGEMENT_INFO' => 'Вернуться на Главную',
  ...
  'LBL_CURRENT_USER_FILTER' => 'Только мои элементы:',
  ...
  'LBL_EMAIL_PDF_BUTTON_LABEL' => 'Отправить по Email как PDF',
  'LBL_EMAIL_PDF_BUTTON_TITLE' => 'Отправить по Email как PDF [Alt+M]',
  'LBL_EMAILS' => 'E-mail',
...
',
  ...
  'LBL_QUOTES_SHIP_TO' => 'Коммерческие предложения: Отгрузить по адресу',
  ...
  'LBL_SELECT_REPORTS_BUTTON_LABEL' => 'Выбрать из отчетоы',
...
',
  ...
  'LBL_VIEW_PDF_BUTTON_LABEL' => 'Распечатать PDF',
  'LBL_VIEW_PDF_BUTTON_TITLE' => 'Распечатать PDF [Alt+P]',
  'LNK_ABOUT' => 'О системе',
  'LNK_ADVANCED_SEARCH' => 'Расширенный',
  'LNK_BASIC_SEARCH' => 'Базовый',
  'LNK_DELETE_ALL' => 'удал. все',
  'LNK_DELETE' => 'удал.',
  'LNK_EDIT' => 'правка',
  'LNK_GET_LATEST' => 'Получить последние',
  'LNK_GET_LATEST_TOOLTIP' => 'Заменить с последней версией',
  'LNK_HELP' => 'Справка',
  ...
  'NTC_CLICK_BACK' => 'Пожалуйста, нажмите Назад в обозревателе и исправьте ошибку.',
  ...
  'NTC_LOGIN_MESSAGE' => 'Введите, пожалуйста, ваши имя пользователя и пароль:',
  ...
  'LBL_SAVED_VIEWS' => 'Сохранённые просмотры',
  'LBL_NO_RECORDS_FOUND' => '- Найдено 0 записей -',
  'LBL_LOGIN_SESSION_EXCEEDED' => 'Сервер перегружен. Попробуйте ещё раз позднее.',
...
$app_list_strings = array (
  ...
  array (
    ...
    'Self Generated' => 'Самопроизводные',
    'Employee' => 'Сотрудник',
    'Partner' => 'Партнер',
  ...
  array (
    '' => '',
    'Net 15' => 'Чистый доход 15',
    'Net 30' => 'Чистый доход 30',
  ),
  ...
  array (
    '' => '',
    'mailmerge' => 'Составление стандартных писем',
  ...
  array (
    ...
    'Assigned' => 'Поручено',
    'Closed' => 'Закрыто',
    'Pending Input' => 'Ожидает решения',
    'Rejected' => 'Отклонено',
    'Duplicate' => 'Повторно открыто',
  ),
  'case_priority_dom' => 
  array (
    'P1' => 'Высокий',
  ...
  array (
    ...
    'Closed Lost' => 'Не принято и закрыто',
  ...
  array (
    ...
    -11 => '(GMT - 11) Острова Мидуэй, Самоа',
    -10 => '(GMT - 10) Гавайи',
    -9 => '(GMT - 9) Аляска',
    ...
    -1 => '(GMT - 1) Азорские острова',
    0 => 'GMT (время по Гринвичу)',
    1 => '(GMT + 1) Мадрид',
    2 => '(GMT + 2) Афины',
    3 => '(GMT + 3) Москва',
    4 => '(GMT + 4) Кабул',
  ...
  array (
    ...
    'detailed_summary' => 'Детализированный итоговый отчёт',
  ),
  'dom_email_types' => 
  array (
    'out' => 'Отправлено',
  ...
  array (
    ...
    'sales' => 'Новый предварительный контакт',
    'task' => 'Новая задача',
  ...
  'dom_email_errors' => 
  array (
    1 => 'Для выбора только одного пользователя во время прямого назначения пунктов',
    2 => 'Вам необходимо назначить только выбранные пункты во время прямого назначения пунктов',
  ),
  'dom_email_bool' => 
  array (
    'bool_true' => 'Да',
  ...
  'dom_email_link_type' => 
  array (
    '' => 'Почтовый клиент в системе по умолчанию',
  ...
  'wflow_user_type_dom' => 
  array (
    'current_user' => 'Текущие пользователи',
  ...
  array (
    ...
    'Existing Value' => 'Существующая стоимость',
  ),
  'wflow_set_type_dom' => 
  array (
    'Basic' => 'Базовые опции',
  ...
  array (
    ...
    'current_user' => 'Активизировавшийся пользователь',
  ),
  ...
  array (
    ...
    -9 => '(GMT - 9) Аляска',
    -8 => '(GMT - 8) ',
    -7 => '(GMT-6) MST - стандартное горное время',
    -6 => '(GMT-6) (CST - центральное поясное время)',
    -5 => '(GMT-5) (EST - стандартное восточное время)',
    -4 => '(GMT - 4) Сантьяго',
    -3 => '(GMT - 3) Буэнос-Айрес',
    -2 => '(GMT - 2) Средняя Атлантика',
    -1 => '(GMT - 1) Азорские острова',
  ...
  array (
    ...
    'seed' => 'Внутренний контрольный список',
  ...
  array (
    'Contacts' => 'Контакты',
    'Users' => 'Пользователи',
    'Prospects' => 'Обзор потенциальных клиентов',
    'Leads' => 'Предварительные контакты',
  ),
  'contract_status_dom' => 
  array (
