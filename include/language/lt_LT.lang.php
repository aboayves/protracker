...
$app_strings = array (
  ...
  'LBL_PORTAL_PASSWORDS_MUST_MATCH' => 'Slaptažodžiai turi sutapti.',
  'LBL_PORTAL_PASSWORD_SUCCESS_CHANGED' => 'Jūsų slaptažodis buvo sėkmingai atnaujintas.',
  'LBL_PORTAL_PASSWORD_UPDATE_FAILED' => 'Slaptažodžio atnaujinimas nepavyko. Prašome bandyti vėl arba susisiekti su techniniu aptarnavimu.',
  'LBL_PORTAL_PASSWORD_VERIFICATION_FAILED' => 'Neteisingas slaptažodis',
  ...
  'LBL_PORTAL_SAVING' => 'Saugoma ( defined in ./include/language/lt_LT.lang.php )',
  ...
  'LBL_TOUR_FEATURES' => '<ul style=""><li class="icon-ok">PDF šablonai moduliams </li><li class="icon-ok">Pasikartojančius susitikimų ir skambučių  planavimas iš peržiūros formos</li><li class="icon-ok">Klientų kontaktams pakvietimai į susitikimus ir mokymus</li><li class="icon-ok">Administratoriui pranešimas apie globalios paieškos indeksavimas užsibaigia</li><li class="icon-ok">Rašybos tikrinimas TinyMCE redaktoriuje</li><li class="icon-ok">IE 8 daugiau nebepalaikoma</li></ul>',
  'LBL_TOUR_IE8' => 'Internet Explorer 8',
  'LBL_TOUR_IE8_DESCRIPTION' => 'Internet Explorer 8 daugiau nebepalaikomas',
  'LBL_TOUR_MEETINGS_CALLS' => 'Susitikimai ir skambučiai',
  'LBL_TOUR_MEETINGS_CALLS_DESCRIPTION' => '<ul><li class="icon-ok">Pasikartojančius susitikimus ir skambučius dabar galima planuoti iš peržiūros formos</li><li class="icon-ok">Dabar galima ir klientų kontaktams duoti pakvietimus į susitikimus ir skambučius</li></ul>',
  'LBL_TOUR_NEXT' => 'Toliau',
  'LBL_TOUR_NOTIFICATIONS' => 'Pranešimai',
  'LBL_TOUR_NOTIFICATIONS_DESCRIPTION' => '<div style="float: left;"><div class="well" style="float: left; width: 317px; margin-right: 20px;"><img src="themes/default/images/pt-notifications.png" width="317" height="212"><div class="caption">Notifications</div></div><div style="float: left; width: 400px;"><ul><li class="icon-ok">Dabar administratoriai gaus pranešimą, kada pilno teksto paieškos indeksavimas bus užbaigtas.</li></ul></div></div><div class="clear"></div>',
  'LBL_TOUR_PDF_MANAGER' => 'Naujas PDF',
  'LBL_TOUR_PDF_MANAGER_DESCRIPTION' => '<div style="float: left;"><div class="well" style="float: left; width: 157px; margin-right: 20px;"><img src="themes/default/images/pt-pdf-manager.png" width="157" height="167"><div class="caption">PDF Manager link in Admin</div></div><div style="float: left; width: 400px;"><ul><li class="icon-ok">Administratoriai gali redaguoti pasiūlymo ir sąskaitos šablonus</li><li class="icon-ok">Administratoriai gali sukurti naujus šablonus standartinimas ir nestandartiniams moduliams</li><li class="icon-ok">Įmonė gali susikurti unikalų PDF dokumentą, kuris paimtų duomenis iš bet kurio Sugar modulio</li></ul><p>Spauskite Administratoriaus nuorodą Profilio menu, ir Jūs pamatysite PDF valdymas nuorodą sistemos nustatymai skiltyje</p><i class="icon-arrow-left icon-lg" style="float: right; position: relative; right: 444px; top: -92px;"></i></div></div><div class="clear"></div>',
  ...
  'LBL_TOUR_SPELL_CHECK' => 'Rašybos tikrinimas',
  'LBL_TOUR_SPELL_CHECK_DESCRIPTION' => '<div style="float: left;"><div class="well" style="float: left; width: 112px; margin-right: 20px;"><img src="themes/default/images/pt-spell-check.png" width="112" height="212"><div class="caption">Spell check menu</div></div><div style="float: left; width: 400px;"><ul><li class="icon-ok">Dabar rašyba tikrinima, kai rašomi nauji laiškai, redaguojami PDF arba laiškų šablonai.</li></ul></div></div><div class="clear"></div>',
