...
$app_strings = array (
  ...
  'LBL_TOUR_FEATURES' => '<ul style=""><li class="icon-ok">モジュールでのカスタムPDFテンプレートの適用</li><li class="icon-ok">会議や電話の詳細画面からの定期的な予定の作成</li><li class="icon-ok">会議や電話のスケジュール時における招待者の取引先からの検索</li><li class="icon-ok">グローバル検索インデックスの完了通知</li><li class="icon-ok">TinyMCEエディタでのスペルチェックの利用</li><li class="icon-ok">IE8の非サポート</li></ul>',
  'LBL_TOUR_NEXT' => '次へ',
  'LBL_TOUR_REFERENCE_1' => ' ',
  'LBL_TOUR_REFERENCE_2' => 'は、プロフィールメニューの中の 「サポート」リンクからいつでも参照できます。',
  'LBL_TOUR_SCREEN_1_DESCRIPTION' => '予算の数値を設定してください<br />パイプラインとノルマ達成状況の記録をつけてください<br />営業チームのパイプラインの予算を入れてください',
  'LBL_TOUR_SCREEN_1_TITLE' => '新しい予算モジュールを使えます',
  'LBL_TOUR_SCREEN_2_DESCRIPTION' => '会計年度の開始日を選択してください<br />年度もしくは四半期の範囲を選んでください<br />予算を設定する範囲の数字を選んでください<br />予算に含まれる確度の範囲を選んでください<br />予算のシナリオを、達成可能、ベスト、ワーストのように選んでください',
  'LBL_TOUR_SCREEN_2_TITLE' => '予算の数値をセットアップします',
  'LBL_TOUR_SCREEN_3_DESCRIPTION' => '予算の期間を選んでください<br />商談の確度を見直しして編集してください<br />予算ワークシートをコミットせずに保存してください　もしくは<br />予算をコミットして以前のコミットを閲覧してください',
  'LBL_TOUR_SCREEN_3_TITLE' => 'パイプラインを管理する',
  'LBL_TOUR_SCREEN_4_DESCRIPTION' => 'あなたの商談の予定営業売上のグラフとテーブルを見る<br />営業ステージと確度別の設定を編集する',
  'LBL_TOUR_SCREEN_4_TITLE' => 'パイプラインを管理する',
  'LBL_TOUR_SCREEN_5_DESCRIPTION' => '見る期間を選択してください<br />営業チームのコミットされたワークシートを見て、予定を調整する<br />営業チームのメンバーが新しい予定をコミットしたときに、アラートを見る<br />コミットせずにワークシートを保存する　もしくは<br />マネージャーに予定をコミットして、過去のコミットの履歴を見る',
  'LBL_TOUR_SCREEN_5_TITLE' => '営業チームのパイプラインを管理する',
  'LBL_TOUR_SCREEN_6_DESCRIPTION' => '営業チーム全体もしくは営業メンバー別に、予想の営業成績のグラフとテーブルを見る<br />達成可能、ベスト、ワーストケースで予想営業成績を見ることのできるグラフに変える',
  'LBL_TOUR_SCREEN_6_TITLE' => '営業チームのパイプラインを管理する',
  'LBL_TOUR_SKIP' => 'スキップ',
