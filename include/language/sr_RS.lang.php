...
$app_strings = array (
  ...
  'ERR_MOBILE_INTERNAL' => 'Unutrašnja greška ({{{kod}}}). Molim vas probajte kasnije.',
  ...
  'LBL_CREATE_MODULE' => 'Kreirati {{{ovo}}}',
  ...
  'LBL_RELATED_MODULE' => 'Povezani {{{ovo}}}',
  'LBL_RELATED_MODULE_PLURAL' => 'Povezani {{{ovo}}}',
  ...
  'LBL_SUPPORT_EMAIL_SUBJECT' => 'Zahtev za podršku',
  ...
  'LBL_TOUR_FEATURES' => '<ul style=""><li class="icon-ok">Dodeli lične PDF šablone svim modulima</li><li class="icon-ok">Kreiraj obnavljajuće Sastanke i Pozive iz detaljnog pogleda</li><li class="icon-ok">Pretraži zvanice po nalogu prilikom zakazivanja Sastanaka i Poziva</li><li class="icon-ok">Administratori su obavešteni nakon završenog indeksiranja Globalne pretrage</li><li class="icon-ok">Provera pravopisa je sada dostupna u TinyMCE Editoru</li><li class="icon-ok">IE 8 nije više podržan</li></ul><p>and much more!</p>',
  ...
  'LBL_TOUR_SCREEN_1_DESCRIPTION' => '<div style="float: left;"><div style="float: left; width: 300px;"><ul><li class="icon-ok">Podesite svoje parametre za prognozu</li><li class="icon-ok">Pratite svoju projektovanu prodaju</li><li class="icon-ok">Prognozirajte buduću projektovanu prodaju vašeg tima</li></ul></div><div class="well" style="float: left; width: 220px; margin-left: 20px;"><img src="themes/default/images/pt-screen1-thumb.png" width="220" id="thumbnail_1" class="thumb"></div></div><div class="clear"></div>',
  'LBL_TOUR_SCREEN_1_TITLE' => 'Sada možete prognozirati u Sugaru',
  'LBL_TOUR_SCREEN_2_DESCRIPTION' => '<div style="float: left;"><div style="float: left; width: 300px;"><ul><li class="icon-ok">Odaberite početak fiskalne godine</li><li class="icon-ok">Odaberite godišnje ili kvartalne periode</li><li class="icon-ok">Odaberite broj vremenskih perioda za prognozu</li><li class="icon-ok">Odaberite kategorije za uključivajne u prognozu</li><li class="icon-ok">Odaberite opsege za prognozu, kao što su najverovatniji, najbolji ili najgori.</li></ul></div><div class="well" style="float: left; width: 220px; margin-left: 20px;"><img src="themes/default/images/pt-screen2-thumb.png" width="167" id="thumbnail_2" class="thumb"></div></div><div class="clear"></div>',
  'LBL_TOUR_SCREEN_2_TITLE' => 'Podesite svoje parametre za prognozu',
  'LBL_TOUR_SCREEN_3_DESCRIPTION' => '<div style="float: left;"><div style="float: left; width: 300px;"><ul><li class="icon-ok">Odaberite vremenski period za pregled</li><li class="icon-ok">Pregledajte prodajne planove vašeg time i prilagodite njihovu prognozu</li><li class="icon-ok">Pogledajte alarme kada vaš prodajni tim podnese nove prognoze</li><li class="icon-ok">Sačuvajte svoje radne stranice bez podnošenja planova;</li><li class="icon-ok">Podnesite prognozu menadžeru i pregledajte istoriju prethodnih planova</li></ul></div><div class="well" style="float: left; width: 220px; margin-left: 20px;"><img src="themes/default/images/pt-screen3-thumb.png" width="220" id="thumbnail_3" class="thumb"></div></div><div class="clear"></div>',
  'LBL_TOUR_SCREEN_3_TITLE' => 'Upravljanje projektovanom prodajom svog tima',
  'LBL_TOUR_SCREEN_4_DESCRIPTION' => '<div style="float: left;"><div style="float: left; width: 300px;"><ul><li class="icon-ok">Pogledajte grafikone ili tabele sa projektovanim prodajnim brojevima za celokupan prodajni tim ili individualnog člana tima</li><li class="icon-ok">Izmenite grafikon tako da vizuelizuje projektovanu prodaju po Najverovatnijem, Najboljem ili Najgorem slučaju</li></ul></div><div class="well" style="float: left; width: 220px; margin-left: 20px;"><img src="themes/default/images/pt-screen4-thumb.png" width="220" id="thumbnail_4" class="thumb"></div></div><div class="clear"></div>',
  'LBL_TOUR_SCREEN_4_TITLE' => 'Upravljanje projektovanom prodajom svog tima',
  'LBL_TOUR_SCREEN_5_DESCRIPTION' => '<div style="float: left;"><div style="float: left; width: 300px;"><ul><li class="icon-ok">Odaberite vremenski period za Vašu prognozu</li><li class="icon-ok">Pregledajte i uredite iznose i verovatnoću za svoje Prodajne prilike</li><li class="icon-ok">Sačuvajte vaše predviđanje bez podnošenja;</li><li class="icon-ok">Podnesite svoju prognozu menadžeru i pogledajte istoriju prethodnih planova</li></ul></div><div class="well" style="float: left; width: 220px; margin-left: 20px;"><img src="themes/default/images/pt-screen5-thumb.png" width="220" id="thumbnail_5" class="thumb"></div></div><div class="clear"></div>',
  'LBL_TOUR_SCREEN_5_TITLE' => 'Upravljajte svojiim projektovanim prodajama',
  'LBL_TOUR_SCREEN_6_DESCRIPTION' => '<div style="float: left;"><div style="float: left; width: 300px;"><ul><li class="icon-ok">Pogledajte grafik i tabele projektovane prodaje za svoje prodajne prilike</li><li class="icon-ok">Uredite podešavanja po prodajnoj fazi i verovatnoći</li></ul></div><div class="well" style="float: left; width: 220px; margin-left: 20px;"><img src="themes/default/images/pt-screen6-thumb.png" width="220" id="thumbnail_6" class="thumb"></div></div><div class="clear"></div>',
  'LBL_TOUR_SCREEN_6_TITLE' => 'Upravljajte svojim projektovanim prodajama',
