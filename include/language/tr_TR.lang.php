...
$app_strings = array (
  ...
  'LBL_PORTAL_LOGIN_FORGOTPASSWORD_TITLE' => 'Şifreniz unutuldu?',
  ...
  'LBL_PORTAL_TOUR_SCREEN1_BODY' => '<ul class="features"><br /><li class="icon-ok">Daha hızlı ve etkileşimli kullanıcı deneyimi</li><br /><li class="icon-ok">Çok uluslu çalışma desteği</li><br /><li class="icon-ok">Yeni ve güncellenmiş Hatalar, Talepler ve Bilgi Bankası Makalelerini takip etmek için Gösterge Panosu</li><br /><li class="icon-ok">Global Arama</li><br /><li class="icon-ok">Şifre değiştirme becerisi</li><br /></ul><br /><p class="small">Ve çok daha fazlası!</p><br /><p class="small"><br />Tam liste için Portal&#39;da <br /><a href="javascript:void window.open(&#39;http://support.sugarcrm.com/02_Documentation/01_Sugar_Editions/&#39;)">Neler Yeni</a> ziyaret edin..<br /></p>',
  'LBL_PORTAL_TOUR_SCREEN1_TITLE' => 'Portal Turu&#39;na Hoşgeldiniz',
  'LBL_PORTAL_TOUR_SCREEN2_BODY' => '<p>Gösterge Panoları ana sayfanızı temsil eder. Şirketinizin Taleplerinin, Bilgi Bankası Makalelerini ve Hata Bildirimlerinin hızlı bir özetini görüntüler.</p><br /><p>Gösterge Panoları sayfasına geri dönmek için herhangi bir Portal sayfasının sol üst köşesindeki Sugar küp simgesini tıklayın.</p><br /><p>Her bir Gösterge Panosu her modül için değiştirilmiş son beş kayıtı gösterir. Ek kayıtları görüntülemek için, modül linkine tıklayın.</p>',
  'LBL_PORTAL_TOUR_SCREEN2_TITLE' => 'Gösterge Panosu',
  'LBL_PORTAL_TOUR_SCREEN3_BODY' => '<p>Altbilgi barı aşağıdakiler için kullanılabilir: </p><br /><ul class="features"><br /><li class="icon-ok">Dil: Tercih ettiğiniz dili seçtiğinizde, Portal tüm etiketleri tercüme edecektir. Not: Dil sadece oturum açma sırasında altbilgi kısmından seçilebilir.</li><br /><li class="icon-ok">Tur: Yeni Sugar Portal özellikleri ile tanışın.</li><br /><li class="icon-ok">Yazdır: Kişisel kayıtlarınız için Sugar Portal sayfasının bir yazıcı çıktısını oluşturun.</li><br /><li class="icon-ok">Üst: Sugar Portal Sayfasının içinde en üste git.</li><br /></ul><br /><p></p>',
  'LBL_PORTAL_TOUR_SCREEN3_TITLE' => 'Altbilgi',
  'LBL_PORTAL_TOUR_SCREEN4_BODY' => '<p>İki tür arama bulunmaktadır:</p><br /><ul class="features"><br /><li class="icon-ok">Global Arama- Navigasyon barında bulunur. Burada Talepleri, Hataları ve Bilgi Bankasındaki Dökümanları isimlerinden ve numaralarından arayabilirsiniz.</li><br /><li class="icon-ok">Spesifik modül Arama- Her modül için liste görünümünde üst kısımda bulunur.<br><br /><img width="530" height="200" style="margin-top: 10px;" src="../themes/default/images/ppt-search.png"><br /><i class="icon-arrow-left icon-lg" style="float: right; position: relative; right: 311px; top: -147px;"></i><br /></li><br /></ul>',
  'LBL_PORTAL_TOUR_SCREEN4_TITLE' => 'Ara',
  'LBL_PORTAL_TOUR_SCREEN5_BODY' => 'Profil sayfaından, örneğin şifre değiştirebilir, e-posta adresini güncelleyebilir ve tercih ettiğiniz dili seçebilirsiniz.',
  'LBL_PORTAL_TOUR_SCREEN5_TITLE' => 'Profil',
  'LBL_PORTAL_TOUR_SCREEN6_BODY' => 'İstediğiniz zaman turu tekrarlıyabilir veya daha fazla bilgi için<br /><a href="javascript:void window.open(&#39;http://support.sugarcrm.com/02_Documentation/01_Sugar_Editions/&#39;)">dökümantasyonu</a> okuyabilirsiniz.',
  'LBL_PORTAL_TOUR_SCREEN6_TITLE' => 'İşleminiz Bitti!',
  'LBL_PORTAL_TOUR_SKIP_LNK' => 'Atla',
  'LBL_PORTAL_TOUR_TAKE_TOUR_LNK' => 'Tura katılın',
  ...
  'LBL_SEARCH_ALL' => '{{{this}}} tümünde ara',
  ...
  'LBL_SEARCH_TIPS' => 'Tam bir eşleşme elde etmek için ara butonuna veya enter tuşuna basın.',
  ...
  'LBL_THEME_PICKER_IE6COMPAT_CHECK' => 'Uyarı: Internet Explorer 6 seçilen tema tarafından desteklenmektedir. Seçmek istediğinizden eminseniz Tamam tuşuna, farklı tema seçmek için İptal tuşuna basınız.',
  ...
  'MSG_DUPLICATE' => 'Oluşturmak istediğiniz kayıt {0} zaten var olan bir {0} kaydının kopyası olabilir. Benzer isimler içeren {1} kayıtları aşağıda listelenmiştir. <br> {0} yeni kaydı için {1} Oluştur tuşuna basın veya aşağıda listelenen {0} değerlerinden birini seçin.',
  ...
  'MSG_JS_ALERT_MTG_REMINDER_CALL_MSG' => 'Bu aramayı görüntülemek için Tamam tuşuna basın yada bu mesajı kapatmak için İptal butonuna tıklayın.',
  'MSG_JS_ALERT_MTG_REMINDER_DESC' => 'Tanım:',
  'MSG_JS_ALERT_MTG_REMINDER_LOC' => 'Yer:',
  'MSG_JS_ALERT_MTG_REMINDER_MEETING' => 'Toplantı',
  'MSG_JS_ALERT_MTG_REMINDER_MEETING_MSG' => 'Bu toplantıyı görüntülemek için Tamam&#39;a tıklayın yada bu mesajı kapatmak için iptal butonuna tıklayın.',
...
$app_list_strings = array (
  ...
  'forecasts_timeperiod_month_options_dom' => 
  array (
    '' => ' ',
    1 => 'Ocak',
    2 => 'Şubat',
