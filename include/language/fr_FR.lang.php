...
$app_strings = array (
  'LBL_QUICK_CREATE_TITLE' => 'LBL_QUICK_CREATE_TITLE',
  ...
  'LBL_EMAIL_ADDRESS_BOOK_TITLE_ICON' => '<img src='. SugarThemeRegistry::current()->getImageURL('icon_email_addressbook.gif') . ' align=absmiddle border=0> Carnet d&#39;adresses',
  ...
  'LBL_EMAIL_FOLDERS' => '<img src='. SugarThemeRegistry::current()->getImageURL('icon_email_folder.gif') . ' align=absmiddle border=0> Dossiers',
  ...
  'LBL_EMAIL_IMPORT_SETTINGS' => 'Importation',
  ...
  'LBL_EMAIL_MARK_FLAGGED' => 'comme "avec Drapeau"',
  'LBL_EMAIL_MARK_READ' => 'comme "lu"',
  'LBL_EMAIL_MARK_UNFLAGGED' => 'comme "sans Drapeau"',
  ...
  'LBL_EMAIL_QC_BUGS' => 'Créer un nouveau Bug et lui lier cet email',
  'LBL_EMAIL_QC_CASES' => 'Créer un nouveau Ticket et lui lier cet email',
  'LBL_EMAIL_QC_LEADS' => 'Créer un nouveau Lead et lui lier cet email',
  'LBL_EMAIL_QC_CONTACTS' => 'Créer un nouveau Contact et lui lier cet email',
  'LBL_EMAIL_QC_TASKS' => 'Créer une nouvelle Tâche et lui lier cet email',
  ...
  'LBL_EMAIL_SEARCH' => '<img src='. SugarThemeRegistry::current()->getImageURL('Search.gif') . ' align=absmiddle border=0> Rechercher',
  ...
  'LBL_UPLOAD_IMAGE_FILE_INVALID' => 'Format de fichier invalide,seulement des images peuvent être téléchargé.',
  ...
  'WARN_LICENSE_SEATS_MAXED' => 'Attention: vous avez plus d&#39;utilisateurs actifs que le nombre autorié par votre licence.',
  'WARN_ONLY_ADMINS' => 'Seuls les administrateurs peuvent se connecter.',
  'WARN_UNSAVED_CHANGES' => 'Vous êtes sur le point de quitter cet enregistrement sans sauvegarder vos modifications. Etes-vous sûr de vouloir perdre vos modifications ?',
  ...
  'LBL_MANAGE_SUBSCRIPTIONS' => 'Abonnements aux Newletters',
  ...
  'MSG_EMPTY_LIST_VIEW_NO_RESULTS' => "Vous n&#39;avez aucun résultat sauvegardé. <item2> ou <item3> maintenant.",
  'MSG_EMPTY_LIST_VIEW_NO_RESULTS_SUBMSG' =>	"<item4> pour en savoir plus sur le module <item1>. Pour accéder à plus d&#39;informations, utilisez le menu utilisateur situé sur la barre de navigation principale pour accéder à l&#39;aide.",
  ...
  'LBL_DB_ROUND_TRIPS' => 'Base de donnée Roundtrips',
  ...
  'LBL_PORTAL_WELCOME_INFO' => 'Le Portail est un environnement qui permet de voir en temps réel les tickets, bugs, newletters, etc des contacts (clients). Ceci est une interface externe de votre CRM qui peut être déployée dans n&#39;importe quel site Web. Restez à l&#39;écoute pour de nouveau service client comme la Gestion de Projet et le forum dans nos prochaines releases.',
  'LBL_LIST' => 'Liste',
  ...
  'LBL_OPERATOR_IN_TEXT' => 'est prami:',
  ...
  'LBL_MASSUPDATE_DELETE_USER_EXISTS' => 'L&#39;équipe privé [{0}] ne peut être supprimé avant que l&#39;utilisateur [{1}] ne soit supprimé',
  'LBL_NO_FLASH_PLAYER' => 'Vous n&#39;avez pas lancé ou vous avez une ancienne version d&#39;Adobe Flash Player. Merci d&#39;<a href="http://www.adobe.com/go/getflashplayer/">installer la dernière version de Flash player</a> ou de lancer Adobe Flash Player.',
...
$app_list_strings = array (
  ...
  array (
    0 => 'Non utilisable dans la recherche de doublons et NON Fusionnable',
