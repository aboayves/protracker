...
$app_strings = array (
  ...
  'LBL_PORTAL_SEARCH_RESULTS_TITLE' => 'Показать результаты поиска для "{запрос}"',
  ...
  'MSG_EMPTY_LIST_VIEW_NO_RESULTS_SUBMSG' => 'чтобы узнать больше о данном модуле. Чтобы получить больше информации, откройте Помощь в пользовательском выпадающем меню, которое расположено в верхнем навигационном меню.',
