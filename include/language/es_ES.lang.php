...
$app_strings = array (
  ...
  'LBL_TOUR_FEATURES' => '<ul style=""><li class="icon-ok">Aplique plantillas de PDF personalizadas a todos los módulos</li><li class="icon-ok">Cree Reuniones y Llamadas recurrentes desde la vista de detalles</li><li class="icon-ok">Busque los asistentes por cuenta al programar una Reunión o Llamada</li><li class="icon-ok">Los Administradores son notificados al completarse las indexación de la Búsqueda Global</li><li class="icon-ok">El corrector ortográfico está disponible en el Editor TinyMCE</li><li class="icon-ok">IE 8 ya no está soportado</li></ul>',
