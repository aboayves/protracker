...
$app_strings = array (
  ...
  'LBL_PORTAL_PASSWORDS_MUST_MATCH' => 'Le passwords devono corrispondere.',
  'LBL_PORTAL_PASSWORD_SUCCESS_CHANGED' => 'La password è stata aggiornata con successo.',
  'LBL_PORTAL_PASSWORD_UPDATE_FAILED' => 'Aggiornamento password non riuscito. Riprovare o contattare il supporto tecnico.',
  'LBL_PORTAL_PASSWORD_VERIFICATION_FAILED' => 'La password inserita non corrisponde a quella del nostro sistema.',
  ...
  'LBL_TOUR_FEATURES' => '<ul style=""><li class="icon-ok">Applica modelli personalizzati di PDF a tutti i moduli</li><li class="icon-ok">Crea Riunioni e Chiamate ricorrenti dalla vista di dettaglio</li><li class="icon-ok">Cerca gli Invitati filtrando per Aziende durante la schedulazione di Riunioni e Chiamate</li><li class="icon-ok">Gli Amministratori di sistema vengono notificati quanto l&#39;indicizzazione della Ricerca Globale è completata</li><li class="icon-ok">Il Controllo Ortografico è ora disponibile in TinyMCE Editor</li><li class="icon-ok">IE 8 non è più supportato</li></ul>',
  'LBL_TOUR_IE8' => 'Internet Explorer 8',
  'LBL_TOUR_IE8_DESCRIPTION' => '<ul><li class="icon-ok">Il browser Internet Explorer 8 non è più supportato</li></ul>',
  'LBL_TOUR_MEETINGS_CALLS' => 'Riunioni e Chiamate',
  'LBL_TOUR_MEETINGS_CALLS_DESCRIPTION' => '<ul><li class="icon-ok">Riunioni e Chiamate ricorrenti possono essere schedulate dalla vista di dettaglio</li><li class="icon-ok">Gli Invitati a Riunioni e Chiamate possono essere selezionati ricercando per contatti associati alle aziende</li></ul>',
  'LBL_TOUR_NEXT' => 'Avanti',
  'LBL_TOUR_NOTIFICATIONS' => 'Notifiche',
  'LBL_TOUR_NOTIFICATIONS_DESCRIPTION' => '<div style="float: left;"><div class="well" style="float: left; width: 317px; margin-right: 20px;"><img src="themes/default/images/pt-notifications.png" width="317" height="212"><div class="caption">Notifiche</div></div><div style="float: left; width: 400px;"><ul><li class="icon-ok">Gli Amministratori di sistema ora ricevono una notifica quando l&#39;indicizzazione della ricerca full text è completata</li></ul></div></div><div class="clear"></div>',
  'LBL_TOUR_PDF_MANAGER' => 'Nuova Gestione PDF',
  'LBL_TOUR_PDF_MANAGER_DESCRIPTION' => '<div style="float: left;"><div class="well" style="float: left; width: 157px; margin-right: 20px;"><img src="themes/default/images/pt-pdf-manager.png" width="157" height="167"><div class="caption">Link per la Gestione PDF in Admin</div></div><div style="float: left; width: 400px;"><ul><li class="icon-ok">Gli Amministratori di sistema possono modificare modelli predefiniti di Offerte e Fatture</li><li class="icon-ok">Gli Amministratori di sistema possono aggiungere nuovi modelli per moduli standard o personalizzati utilizzando un editor HTML flessibile</li><li class="icon-ok">La nuova Gestione PDF permette alle aziende di creare documenti PDF personalizzati unendo dati provenienti da qualsiasi record in qualsiasi modulo</li></ul><p>Clicca in Admin sul menu di Profilo per trovare un link alla Gestione PDF sulle Impostazioni di Sistema</p><i class="icon-arrow-left icon-lg" style="float: right; position: relative; right: 444px; top: -92px;"></i></div></div><div class="clear"></div>',
  ...
  'LBL_TOUR_SKIP' => 'Salta',
  'LBL_TOUR_SPELL_CHECK' => 'Controllo Ortografico',
  'LBL_TOUR_SPELL_CHECK_DESCRIPTION' => '<div style="float: left;"><div class="well" style="float: left; width: 112px; margin-right: 20px;"><img src="themes/default/images/pt-spell-check.png" width="112" height="212"><div class="caption">Menu Controllo Ortografico</div></div><div style="float: left; width: 400px;"><ul><li class="icon-ok">Il Controllo Ortografico è ora disponibile per la composizione di Emails, modifiche ai modelli di PDF, modifiche ai modelli di emails nel modulo Email, Campagne e Workflow.</li></ul></div></div><div class="clear"></div>',
