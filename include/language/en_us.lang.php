...
"5. Click on the Import option from the Actions menu in the application and choose the file to upload"
   ',
    ...
    'LBL_FIRST_INPUT_EDIT_VIEW_KEY' => '1',
    'LBL_ADV_SEARCH_LNK_KEY' => 'a',
    'LBL_FIRST_INPUT_SEARCH_KEY' => '1',
    'LBL_GLOBAL_SEARCH_LNK_KEY' => '0',
    'LBL_KEYBOARD_SHORTCUTS_HELP_TITLE' => 'Keyboard Shortcuts',
    'LBL_KEYBOARD_SHORTCUTS_HELP' => '<p><strong>Form Functionality - Alt+</strong><br/> I = ed<b>I</b>t (detailview)<br/> U = d<b>U</b>plicate (detailview)<br/> D = <b>D</b>elete (detailview)<br/> S = <b>S</b>ave (editview)<br/> L = cance<b>L</b> (editview) <br/><br/></p><p><strong>Search and Navigation  - Alt+</strong><br/> 1 = first input on Edit form<br/> A = Advanced Search link<br/> 1 = First Search Form input<br/> 0 = Unified search input<br></p><p><strong>Help  - Alt+</strong><br/> H = Open Help<br/></p>' ,
