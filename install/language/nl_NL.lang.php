...
$mod_strings = array (
  ...
  array (
    ...
    'txt_body' => 'Hier is uw gebruikersnaam en een tijdelijk wachtwoord:<br />Gebruikersnaam : $contact_user_user_name<br />Wachtwoord : $contact_user_user_hash<br /><br />$config_site_url<br /><br />Nadat u bent ingelogd met bovenstaand wachtwoord, kan u gevraagd worden om het wachtwoord te wijzigen naar een van uw eigen keuze.',
  ),
  ...
  'ERR_DB_LOGIN_FAILURE_OCI8' => 'De aangegeven database host, gebruikersnaam en/of wachtwoord is ongeldig, en een verbinding met de database kan niet tot stand worden gebracht. Geef aub een geldige host, gebruikersnaam en wachtwoord op.',
  'ERR_DB_OCI8_CONNECT' => 'De aangegeven database host, gebruikersnaam en/of wachtwoord is ongeldig, en een verbinding met de database kan niet tot stand worden gebracht. Geef aub een geldige host, gebruikersnaam en wachtwoord op.',
  ...
  'LBL_DBCONFIG_MSG1' => 'Geef aub de naam in van uw database. Dit wordt de standaard table space welke is toegewezen aan uw gebruiker.',
  ...
  'LBL_OC_ADMIN' => 'Neem a.u.b. contact op met uw beheerder om dit probleem op te lossen.',
  ...
  'ERR_DB_MYSQL_VERSION1' => 'Uw MySQL versie (',
  'ERR_DB_MYSQL_VERSION2' => ') wordt niet ondersteund door SugarCRM. U moet een versie installeren die wel compantibel is met deze Sugar versie. Check de compatibiliteitsmatrix in de releasenotes',
  ...
  'LBL_DBCONF_HOST_NAME_MSSQL' => 'Host Naam \\ Host Instantie',
  ...
  'LBL_MSSQL_FTS' => 'Volledige tekst zoekfunctie',
  'LBL_MSSQL_FTS_INSTALLED' => 'Geinstalleerd',
  'LBL_MSSQL_FTS_INSTALLED_ERR1' => 'Full Text Search mogelijkheid is niet geinstalleerd',
  'LBL_MSSQL_FTS_INSTALLED_ERR2' => 'U kunt nog steeds installeren, maar zonder de "Full Text Search"-functionaliteit. Tenzij u SQL-server met Full Text Search herinstalleert.  Raadpleeg de SQL Server installatiehandleiding of vraag de systeembeheerder',
