...
$mod_strings = array (
  ...
  'LBL_CONFIRM_DIRECTIONS' => 'Lütfen aşağıdaki ayarları onaylayın. Değerlerden herhangi birini değiştirmek istiyorsanız, değiştirmek için "Geri" düğmesini tıklayın. Aksi takdirde, yükleme işlemine başlamak için "İleri" butonuna tıklayınız.',
  ...
  'LBL_LANG_1' => 'Sugar içinde, varsayılan dil (ABD-İngilizce) dışında bir dil kullanmak için, şu anda bir dil paketini yükleyip kurabilirsiniz. Sugar uygulamasının içinden de dil paketlerini yükleyip kurabilirsiniz. Bu adımı atlamak istiyorsanız, İleri tuşuna tıklayınız.',
  ...
  'LBL_PATCH_1' => 'Bu adımı atlamak istiyorsanız, İleri düğmesine tıklayın.',
  ...
  array (
    ...
    'txt_body' => 'Kısa süre önce, $contact_user_pwd_last_changed üzerinde hesap şifrenizi sıfırlama isteğinde bulundunuz.<br /><br />Aşağıdaki adrese tıklayarak, şifrenizi sıfırlayabilirsiniz:<br /><br />$contact_user_link_guid',
  ),
  ...
  array (
    ...
    'txt_body' => 'Aşağıda kullanıcı ismi ve geçici şifre bulunmaktadır:<br />Kullanıcı İsmi :  $contact_user_user_name<br />Şifre: $contact_user_user_hash<br /><br />$config_site_url<br /><br />Üstteki şifreyi kullanıp sisteme girdikten sonra, kendi seçtiğiniz bir parola ile sıfırlama gerekli olabilir.',
  ),
);
