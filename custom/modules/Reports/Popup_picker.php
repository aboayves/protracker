...
class Popup_Picker
{
	...
	function process_page()
	{
		...
		$button .= "<input type='button' name='showAdd'  class='button' 
		onclick=\"window.location = 'index.php?module=Reports&action=ReportsWizard&selected_report_module={$_REQUEST['module_name']}';\" value='Create Report ' />\n<br/>";
