		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-bottom: 20px;">
			<tr>
				<td align='left'><input type='button' title="{$MOD.LBL_PREVIOUS}" class="button" name="{$MOD.LBL_PREVIOUS}" value="{$MOD.LBL_PREVIOUS}" 
					...
					onClick='SUGAR.reports.saveReport();' id="saveBtn">&nbsp;&nbsp;{if !$hide_pre_save_btn}<input type='button' title="{$MOD.LBL_PREVIEW_REPORT}" class="button" name="{$MOD.LBL_PREVIEW_REPORT}" value="{$MOD.LBL_PREVIEW_REPORT}"
					onClick='SUGAR.reports.previewReport();' id="previewBtn">{/if}{/if}{if $record && !$hide_pre_save_btn}&nbsp;&nbsp;<input type='button' title="{$MOD.LBL_SAVE_RUN}" class="button" name="{$MOD.LBL_SAVE_RUN}" value="{$MOD.LBL_SAVE_RUN}"
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0" >
			<tr>
				<td align='left'><input type='button' title="{$MOD.LBL_PREVIOUS}" class="button" name="{$MOD.LBL_PREVIOUS}" value="{$MOD.LBL_PREVIOUS}" 
					...
					onClick='SUGAR.reports.saveReport();' id="saveButton">&nbsp;&nbsp;{if !$hide_pre_save_btn}<input type='button' title="{$MOD.LBL_PREVIEW_REPORT}" class="button" name="{$MOD.LBL_PREVIEW_REPORT}" value="{$MOD.LBL_PREVIEW_REPORT}"
					onClick='SUGAR.reports.previewReport();' id="previewButton">{/if}{/if}{if $record && !$hide_pre_save_btn}&nbsp;&nbsp;<input type='button' title="{$MOD.LBL_SAVE_RUN}" class="button" name="{$MOD.LBL_SAVE_RUN}" value="{$MOD.LBL_SAVE_RUN}"
