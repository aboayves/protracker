<?php
    ...
    class Plot {
        ...
        public function computeLayout() {
			...
			//Setting graph and caption ratio
			if(is_object($this->captionArea)){
				$offset = $this->captionArea->x2 - $this->captionArea->x1 - 100;
				if($offset > 0){
					$this->captionArea->x1 += $offset;
					$this->graphArea->x2 += $offset;
				}
			}
        }
