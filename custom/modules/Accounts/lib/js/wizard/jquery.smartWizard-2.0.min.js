    ...
    a.fn.smartWizard = function (k) {
        ...
        return this.each(function () {
            function z() {
                ...
                b.children("ul").addClass("stepTabs");
                d.addClass("content");
                l = a("<div>Loading</div>").addClass("loader");
                i = a("<div></div>").addClass("actionBar");
                m = a("<div></div>").addClass("stepContainer");
				s = a("<a>" + c.labelCancle + "</a>").attr("href", "#").addClass("buttonCancle").attr("onclick","reports.cancelClick();");
			    ...
			    $(".wizard-custom-topbuttons").append(p).append(n).append(o).append(s);
                ...
                a(f).bind("click", function () {
					nextStep = f.index(this);
					if(f.eq(h).attr("rel") !== f.eq(nextStep).attr("rel"))
					{
						f.eq(h).attr("rel") > f.eq(nextStep).attr("rel") ? $("#pressButton").val('prev') : $("#pressButton").val('next');
                    }else
					{
						$("#pressButton").val('next');
					}
            ...
            function r(d, e) {
                ...
                a(e, b).attr("isDone", 1);
                c.cycleSteps || (1 <= h ? a(s).addClass("buttonDisabled") : a(s).removeClass("buttonDisabled"), 0 >= h ? a(o).addClass("buttonDisabled") : a(o).removeClass("buttonDisabled"), f.length - 1 <= h ? a(n).addClass("buttonDisabled") : a(n).removeClass("buttonDisabled"));
