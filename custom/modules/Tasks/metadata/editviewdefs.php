...
<script>focus_obj = document.getElementById("description");</script>{/literal}',
        ...
        array (
		  ...
		  {html_options name="workflow_parent_type" id="workflow_parent_type" 
			...
			<input type="text" autocomplete="off" value="{$fields.workflow_related_to.value}" size="" tabindex="0" class="sqsEnabledFlex yui-ac-input" id="workflow_related_to" name="workflow_related_to"/>
