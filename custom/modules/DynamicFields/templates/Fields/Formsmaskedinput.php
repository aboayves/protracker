...
function get_body(&$ss, $vardef){
	$edit_mod_strings = return_module_language($GLOBALS['current_language'], 'Administration');
	...
	///////////////////////////////////
	return $ss->fetch('custom/modules/DynamicFields/templates/Fields/Forms/maskedinput.tpl');
}