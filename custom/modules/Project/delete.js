...
function del(title, body, taskID)
{
    ...
    var handleATTACH = function() {
        ...
        YAHOO.util.Connect.asyncRequest('POST','index.php',{'success':function(o){mySimpleDialogWait.hide();generateTree();},'failure':null},'module=Tasks&action=attach_to_parent&id='+taskID+'&sugar_body_only=true');
		}
		var txtWait = '<img src="custom/modules/Tasks/loading.gif" alt="Progress Bar" />';
        del_wait("Please Wait...", txtWait);
        this.hide();
