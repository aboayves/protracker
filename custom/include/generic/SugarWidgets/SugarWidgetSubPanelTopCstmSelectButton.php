...
class SugarWidgetSubPanelTopCstmSelectButton extends SugarWidgetSubPanelTopSelectButton
{
	...
	{
	  	$this->module_name = $widget_data['override_module'];
		$this->form_value = $widget_data['form_value'];
		global $app_strings;
		$initial_filter = '';
		...
		$popup_request_data = array(
			...
			'passthru_data' => array(
				...
				'module_selected'=>$widget_data['override_module'],
			),
		);
