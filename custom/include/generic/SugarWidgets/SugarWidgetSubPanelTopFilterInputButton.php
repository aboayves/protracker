...
<input type='submit' onclick=\"{$onclick}\" href='javascript:void(0)' value='Filter'>
<input type='submit' onclick=\"document.getElementById('filter_param_' + current_child_field).value = '';{$onclick}\" href='javascript:void(0)' value='Clear Filter'>
</form>
EOHTML;
