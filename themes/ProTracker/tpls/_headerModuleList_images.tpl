...
{/php}
  ...
  {/if}
	...
	{else}
		{assign var='homeImageLabel' value='<img src="index.php?entryPoint=getImage&imageName=icon_'|cat:$name|cat:'_32.png" />'}
		{assign var='homeClass' value=''}
		{assign var='title' value=''}
	{/if}
	
	{if $name == $MODULE_TAB}
		<li class="current {$homeClass}">{sugar_link id="moduleTab_$tabGroupName$name" module=$name data=$module label=$homeImageLabel|cat:$module title=$title class="sf-with-ul"}
	{else}
		<li class="{$homeClass}">{sugar_link id="moduleTab_$tabGroupName$name" module=$name data=$module label=$homeImageLabel|cat:$module title=$title class="sf-with-ul"}
	{/if}
	...
	{else}
		...
		{assign var='title' value=''}
	{/if}
    <li {if $smarty.foreach.moduleList.index > 4}class="moreOverflow"{/if}>{sugar_link id="moduleTab_$tabGroupName$module" module="$module" data="$name" label=$homeImageLabel|cat:$module class="sf-with-ul"}
